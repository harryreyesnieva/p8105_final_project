...
plot
```
Now I will merge the pra and comorbidities dataframes and examine for correlations.
```{r}
...
Now I will merge the pra and age dataframes and examine for correlations.
```{r}
...
Now I will merge the pra and gender dataframes and examine for correlations.
```{r}
...
Now I will merge the pra and demographics dataframes and examine for correlations.
```{r}
...
Now I will merge the pra and blood type dataframes and examine for correlations.
```{r}
