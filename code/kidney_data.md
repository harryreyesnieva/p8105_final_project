...
Here we import the kidney data set, clean its column names, and examine
the structure, head, and tail of the data set. Then, we view the data
set.
...
\#Change column names Here we change the column names to more intuitive
ones
...
Here we delete an extraneous row, drop missing values, and convert the
...
![](kidney_data_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](kidney_data_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](kidney_data_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](kidney_data_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](kidney_data_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->

\#Plot outcome variables. Here we plot the outcome variables to get a
...
![](kidney_data_files/figure-gfm/unnamed-chunk-12-1.png)<!-- --> The
...
![](kidney_data_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
Here we import the data frame from another sheet that contains center
...
Here we rename and clean the columns for the patient characteristics
data set.
...
Here we make a dataframe of patient demographics and plot the
...
![](kidney_data_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](kidney_data_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->

Here we make a gender dataframe and plot the gender distributions by
zipcode.
...
![](kidney_data_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->

Here we make a comorbidities dataframe and plot the pra score
distributions by zipcode.
...
![](kidney_data_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->

Here we make a blood type dataframe and plot the blood type
distributions by zipcode.
...
![](kidney_data_files/figure-gfm/unnamed-chunk-21-1.png)<!-- --> Now, I
...
![](kidney_data_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->

Here we merge the pra and comorbidities dataframes and make scatter
...
![](kidney_data_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
Now we merge the pra and age dataframes and and make scatter plots to
...
![](kidney_data_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
Here we merge the pra and gender dataframes and make scatter plots to
investigate for correlations.
...
![](kidney_data_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](kidney_data_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](kidney_data_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
