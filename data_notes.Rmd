...
## Comparisons
Show comparisons between different regions (have a slider for mile radius perhaps based on zipcode?) - use ZipRadius package https://cran.r-project.org/web/packages/ZipRadius/vignettes/ZipRadius.html
...
Tables B* are waiting list info
Tables C* are transplant info
Table D1 is follow-up rates for living DONORS
...
- Table B8: percent of candidates with decreased donor transplants, demographics (percent transplanted at a specific time since listing - 30d, 1y, 2y, 3y)
- Table B9: medical charactersitics of above
- Table B10: time to transplant for waiting list percentiles (months): 5th, 10th, 25th, 50th, 75th
