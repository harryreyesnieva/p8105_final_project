...
<!-- Welcome to the [Scientific Registry of Transplant Recipients](https://www.srtr.org/) Dashboard and Data Repository. Our site utilizes center-level data on waitlisted patients and patients in receipt of transplants including aggregated demographics, transplant outcomes, and organ offer acceptance practices.  -->
...
fig = subplot(fig_a, fig_b, fig_c, fig_d, nrows = 2)
fig  
```
