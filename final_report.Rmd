...
Our initial exploratory analyses began using data from one recent report (August 2020 release). First, we mapped the distribution of transplant centers across the United States.
...
We plotted offer acceptance ratios over time at all centers, organized by the 11 OPTN regions. 
